...
<?php
	    ...
	    $result0 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time0}';");
	    ...
	    $result12 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time12}';");
	    $result13 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time13}';");
	    $result14 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time14}';");
	    $result15 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time15}';");
	    $result16 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time16}';");
	    $result17 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time17}';");
	    $result18 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time18}';");
	    $result19 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time19}';");
	    $result20 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time20}';");
	    $result21 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time21}';");
	    $result22 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time22}';");
	    $result23 = mysqli_query($con,"select STARTX,STARTY from point where startTime ='{$time23}';");
